...
<style type="text/css">a, a:hover{color :#000000; text-decoration:none;}</style>
</head>
<body>
	<%
	String userID = null;
			...
			<table class="table table-hover" style="text-align: center; border: 1px solid #ddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="view.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle().replaceAll(" ","&nbsp").replace("<","&lt;").replace(">","&gt;").replaceAll("\n","")%></a></td>
