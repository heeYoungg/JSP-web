			...
			<table class="table table-hover" style="text-align: center; border: 1px solid #ddddd">
				...
				<tbody>
					<tr>
						...
						<td colspan="2"><%= bbs.getBbsTitle().replaceAll(" ","&nbsp").replace("<","&lt;").replace(">","&gt;").replaceAll("\n","") %></td>
					</tr>	
					<tr>	
						<td>작성자</td>
					...
					<tr>	
						<td>내용</td>
						<td colspan="2" style="min-height:200px; text-align:center;"><%= bbs.getBbsContent().replaceAll(" ","&nbsp").replace("<","&lt;").replace(">","&gt;").replaceAll("\n","") %></td>				
					</tr>
				</tbody>
			</table>
